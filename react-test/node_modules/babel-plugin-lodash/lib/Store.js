...
var Store = function (_MapCache) {
  ...
  _createClass(Store, [{
    ...
    value: function set(id) {
      var pkgStore = arguments.length <= 1 || arguments[1] === undefined ? new _PackageStore2.default(id) : arguments[1];

      clear(this);
      return _get(Object.getPrototypeOf(Store.prototype), 'set', this).call(this, id, pkgStore);
    }
  }]);
